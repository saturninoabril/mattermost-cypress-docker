...
describe('Demo plugin - Webhook events', () => {
    ...
    it('MM-T2408/2 - User posts a message Webhook event', () => {
        // # Post message
        cy.visitAndWait(`/${team1.name}/channels/town-square`).wait(TIMEOUTS.TWO_SEC);
    ...
    it('MM-T2408/3 - User joined a channel Webhook event', () => {
        // # Join channel
        cy.visitAndWait(`/${team1.name}/channels/${testChannel}`).wait(TIMEOUTS.TWO_SEC);
    ...
    it('MM-T2408/5/6 - User edited a message Webhook event', () => {
        ...
        cy.getLastPostId().then((postID) => {
            ...
            cy.visitAndWait(`/${team1.name}/channels/demo_plugin`).wait(TIMEOUTS.TWO_SEC);
    ...
    it('MM-T2408/8/9 - ​User joined the team Webhook event', () => {
        ...
        // # Open demo plugin channel
        cy.visitAndWait(`/${team2.name}/channels/demo_plugin`).wait(TIMEOUTS.TWO_SEC);
    ...
    it('MM-T2408/11 - ​User user created Webhook event', () => {
        ...
        cy.apiCreateUser().then(({user: otherUser}) => {
            // # Open demo plugin channel
            cy.visitAndWait(`/${team1.name}/channels/demo_plugin`).wait(TIMEOUTS.TEN_SEC);
